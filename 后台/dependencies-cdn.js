module.exports = [
  ...
  { name: 'vue', library: 'Vue', js: 'https://cdn.zwlearn.com/CDNs/vue@2.6.10/dist/vue.min.js', css: '' },
  { name: 'vue-i18n', library: 'VueI18n', js: 'https://cdn.zwlearn.com/CDNs/vue-i18n@8.15.1/dist/vue-i18n.min.js', css: '' },
  { name: 'vue-router', library: 'VueRouter', js: 'https://cdn.zwlearn.com/CDNs/vue-router@3.1.3/dist/vue-router.min.js', css: '' },
  { name: 'vuex', library: 'Vuex', js: 'https://cdn.zwlearn.com/CDNs/vuex@3.1.2/dist/vuex.min.js', css: '' },
  { name: 'axios', library: 'axios', js: 'https://cdn.zwlearn.com/CDNs/axios@0.19.0/dist/axios.min.js', css: '' },
  { name: 'better-scroll', library: 'BScroll', js: 'https://cdn.zwlearn.com/CDNs/better-scroll@1.15.2/dist/bscroll.min.js', css: '' },
  { name: 'axios-mock-adapter', library: 'AxiosMockAdapter', js: 'https://cdn.zwlearn.com/CDNs/axios-mock-adapter@1.18.1/dist/axios-mock-adapter.min.js', css: '' },
  { name: 'element-ui', library: 'ELEMENT', js: 'https://cdn.zwlearn.com/CDNs/element-ui@2.13.1/lib/index.js', css: 'https://cdn.zwlearn.com/CDNs/element-ui@2.13.0/lib/theme-chalk/index.css' },
  { name: 'lodash', library: '_', js: 'https://cdn.zwlearn.com/CDNs/lodash@4.17.15/lodash.min.js', css: '' },
  { name: 'ua-parser-js', library: 'UAParser', js: 'https://cdn.zwlearn.com/CDNs/ua-parser-js@0.7.20/dist/ua-parser.min.js', css: '' },
  { name: 'js-cookie', library: 'Cookies', js: 'https://cdn.zwlearn.com/CDNs/js-cookie@2.2.1/src/js.cookie.min.js', css: '' },
  { name: 'nprogress', library: 'NProgress', js: 'https://cdn.zwlearn.com/CDNs/nprogress@0.2.0/nprogress.min.js', css: 'https://cdn.zwlearn.com/CDNs/nprogress@0.2.0/nprogress.css' },
  { name: 'dayjs', library: 'dayjs', js: 'https://cdn.zwlearn.com/CDNs/dayjs@1.8.17/dayjs.min.js', css: '' },
  { name: 'fuse.js', library: 'Fuse', js: 'https://cdn.zwlearn.com/CDNs/fuse.js@5.2.3/dist/fuse.min.js', css: '' },
  { name: 'hotkeys-js', library: 'hotkeys', js: 'https://cdn.zwlearn.com/CDNs/hotkeys-js@3.7.3/dist/hotkeys.min.js', css: '' },
  { name: 'qs', library: 'Qs', js: 'https://cdn.zwlearn.com/CDNs/qs@6.9.1/dist/qs.js', css: '' },
  { name: 'lowdb', library: 'low', js: 'https://cdn.zwlearn.com/CDNs/lowdb@1.0.0/dist/low.min.js', css: '' },
  { name: 'lowdb/adapters/LocalStorage', library: 'LocalStorage', js: 'https://cdn.zwlearn.com/CDNs/lowdb@1.0.0/dist/LocalStorage.min.js', css: '' },
  { name: 'screenfull', library: 'screenfull', js: 'https://cdn.zwlearn.com/CDNs/screenfull@5.0.2/dist/screenfull.min.js', css: '' },
  { name: 'sortablejs', library: 'Sortable', js: 'https://cdn.zwlearn.com/CDNs/sortablejs@1.10.1/Sortable.min.js', css: '' },
]
