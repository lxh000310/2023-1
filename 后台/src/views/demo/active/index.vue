<template>
  <d2-container>
    ...
    <el-button type="primary" size="small" v-show="true" v-if="searchUserRole('/oms-order/order/sku/add')"  @click="addNewSku()">新建活动</el-button>
    <hr>
    <el-table :data="tableData" v-loading="loading" style="width: 100%;" ref="xTable">
      ...
      <el-table-column prop="name" label="活动名称" align='center' width="150">
      </el-table-column>
      <el-table-column label="活动时间" align='center'>
        <template slot-scope="scope">
          <div>{{scope.row.activeBegin}}至{{scope.row.activeDeadline}}</div>
        </template>
      </el-table-column>
      <el-table-column prop="releaseState" label="活动状态" align='center' width="150">
      </el-table-column>
...
<script>
  ...
  import {SearchAllAct} from '@/api/aboutAct'
